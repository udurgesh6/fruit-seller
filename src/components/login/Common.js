  ...
  return (
    <>
      <div className="overflow-hidden bg-white mx-auto">
        ...
        <div className="hidden my-8 after:bg-gray-100 before:bg-gray-100 fo10t-sans text-center font-medium">
          OR
        </div>

        <div className="hidden justify-between flex-col lg:flex-row">
        ...
        <div className="text-center text-sm text-gray-900 mt-4">
          <div className="text-gray-500 mt-2.5">
            ...
            <button
              onClick={handleModal}
              className="text-gray-800 hover:new-text-600 font-bold mx-2"
            >
