      ...
      <div className="h-screen flex items-center justify-center bg-gray-100">
        <div className="bg-white rounded-lg shadow max-w-md w-full space-y-8 py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-2">
            ...
            <p className="text-sm md:text-base text-gray-500 mt-2 mb-4 sm:mb-10">
              {showLogin
          ...
          >
            <div className="grid grid-cols-1 gap-5">
                ...
                <>
                  <div className="form-group">
                    <input
                      ...
                      className="p-2 border border-[#770006] w-full py-2 pl-4 w-full text-sm opacity-75 text-input placeholder-body min-h-12 transition duration-200 ease-in-out h-11 md:h-12 outline-none"
                    />
              ...
              <button
                disabled={loading}
                type="submit"
                className="w-full text-center py-3 font-medium text-sm text-white transition-all focus:outline-none bg-[#770006] my-1"
              >
