                ...
                <div className="grid grid-cols-6 gap-4 lg:gap-6 mt-10">
                  ...
                  <div className="col-span-6 sm:col-span-3">
                    <button
                      ...
                      className="text-white bg-[#770006] transition-all rounded py-3 text-center text-sm font-serif font-medium text-white flex justify-center w-full"
                    >
                      Confirm Order{" "}
