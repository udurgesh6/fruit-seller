const TermAndConditions = () => {
  return (
    <div className="bg-white px-5 md:px-14 lg:px-28">
      <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-3 sm:px-10">
        <div className="mb-8 lg:mb-12 last:mb-0">
          <h2 className="text-xl xl:text-2xl xl:leading-7 font-semibold font-serif mb-2 lg:mb-4">
            Last updated on 29-02-2024 11:05:47
          </h2>
          <div className="font-sans leading-7">
            <p>
              ...
              Quintessentials, ( “Website Owner” or “we” or “us” or “our”) and
            ...
            <ol>
              ...
              <li>
                8. You agree and acknowledge that website and the Services may
              ...
              <li>
                9. You understand that upon initiating a transaction for
                availing the Services you are entering into a legally binding
                and enforceable contract with the us for the Services.
              </li>
              <li>
                10. You shall be entitled to claim a refund of the payment made
              ...
              <li>
                11. Notwithstanding anything contained in these Terms, the
              ...
              <li>
                13. All disputes arising out of or in connection with these
                Terms shall be subject to the exclusive jurisdiction of the
                courts in mumbai, Maharashtra
              </li>
              <li>
                14. All concerns or communications relating to these Terms must
                be communicated to us using the contact information provided on
                this website.
              </li>
            </ol>
          </div>
